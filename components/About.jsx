      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Sothearak is a versatile professional specializing in graphic
              design and web development. With a keen eye for aesthetics and a
              passion for digital innovation, Sothearak brings creativity and
              technical expertise to every project undertaken. Armed with a deep
              understanding of design principles and programming languages,
              Sothearak crafts visually stunning websites and digital
              experiences that captivate and engage audiences. With a commitment
              to excellence and a drive for continuous learning, Sothearak
              strives to push the boundaries of design and technology to deliver
              outstanding results for clients and users alike.
            </p>
            {/* BIOGRAPHY QUOTE */}
